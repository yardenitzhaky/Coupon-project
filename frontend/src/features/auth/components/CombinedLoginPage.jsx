...
const LoginPage = () => {
  ...
  //NOTE - MOVE THE COUPON METHODS TO COUPON SERVICE
    ...
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <Card className="w-full max-w-4xl shadow-2xl transition-all duration-300 hover:shadow-3xl">
        <TabView className="border-none">
          ...
          <TabPanel
            header={
              <div className="flex items-center gap-2 transition-colors duration-200 hover:text-green-600">
                <Tag size={18} />
              ...
              <form onSubmit={handleLogin} className="space-y-4">
                <div className="space-y-2 transition-all duration-200 hover:shadow-sm">
                  ...
                  <InputText
                    ...
                    className={classNames("w-full", { "p-invalid": authErrors.username })}
                  />
                  {authErrors.username && (
